...
const URLImage = ({ image }) => {
  ...
  return (
    <Image
      ...
      offsetX={0}
      offsetY={0}
      width={typeof window !== "undefined" ? window.innerWidth - 166 : "1200px"}
      height={typeof window !== "undefined" ? window.innerHeight - 90 : "578px"}
    />
  );
};
...
export default function CanvasDraw({ tool, image, canvasRef, open, color }) {
  ...
  return (
    <>
      <Stage
        width={
          typeof window !== "undefined" ? window.innerWidth - 166 : "1200px"
        }
        height={
          typeof window !== "undefined" ? window.innerHeight - 90 : "578px"
        }
        ref={canvasRef}
